...
export const contactAction = async (email, fullName, message) => {
    ...
    try {
        ...
        return { success: true, message: "Your message has been sent successfully!" }; // Return a success response to the client when the form submission is successful
        // redirect('/')
    } catch (error) {
